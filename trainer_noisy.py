...
if __name__ == '__main__':
    ...
    parser.add_argument("--version", type=int, default=9, help="model version")
    ...
    log_dir = './logs/noisy_training/{}/run_{}/'.format(args.arch, args.version)
    ...
    """
    python -m tensorboard.main --logdir=./logs/noisy_training/BiGRU/run_7/ --port=6006
